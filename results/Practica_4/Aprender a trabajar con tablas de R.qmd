...
if [ ! -e  ./data/17-02-2026/trypanosoma_annotated.txt ]; then
   ./data/17-02-2026/datasets summary genome taxon Trypanosoma --annotated --as-json-lines | \
   ./data/17-02-2026/dataformat tsv genome --fields \
      accession,organism-name,assminfo-release-date,assminfo-level,assmstats-atgc-count,annotinfo-featcount-gene-total,assminfo-type,assminfo-status > ./data/17-02-2026/trypanosoma_annotated.txt
fi
```
...
library('kableExtra')
genomas <- read.table('./data/17-02-2026/trypanosoma_annotated.txt',
                      header = TRUE, sep = '\t')
...
```{r}
datos_duplicados <- genomas[esta_duplicado,]
...
if [ ! -e ./data/17-02-2026/ncbi_dataset/data/GCA_022059095.1/genomic.gff ]; then
   if [ ! -e ./data/17-02-2026/ncbi_dataset.zip ]; then
      ./data/17-02-2026/datasets download genome accession GCA_022059095.1 --include genome,gff3 --filename ./data/17-02-2026/ncbi_dataset.zip
   fi
   unzip ./data/17-02-2026/ncbi_dataset.zip -d ./data/17-02-2026/
fi
```
...
library('jsonlite')
prettify(readLines('./data/17-02-2026/ncbi_dataset/data/assembly_data_report.jsonl'))
```
...
gff <- read.table('./data/17-02-2026/ncbi_dataset/data/GCA_022059095.1/genomic.gff', sep = '\t',
