...
:::{.callout-note icon=false}
## Solución
Para poder elaborar dicha URL; lo primero que queremos es identidifar el ID de *Drosophila*. Para ello, nos metemos en el NCBI taxonomy browser y encontramos que el ID es 7215. Por otro lado, tenemos que tener en cuenta que estamos buscando exclusivamente la enzima alcohol deshidorgenasa, es decir, una secuencia de una proteína. Por tanto, nuestra search será de una secuencia. 

Además, como solo queremos las alcohol deshidorgenasas, vamos a ponerle otra quey adicional a el ID que será que aparezca el nombre alcohol deshidrogenasa. 
