...
curl_download('https://www.ebi.ac.uk/ena/portal/api/search?result=assembly&query=tax_tree(6157) AND genome_representation="full"&fields=version,tax_id,scientific_name,last_updated,base_count&limit=0',
              destfile = './data/24-02-2026/z1.txt')
```
...
curl_download(URLencode(URL), destfile = './data/24-02-2026/z2.txt')
...
curl_download(
  URLencode('https://www.ebi.ac.uk/ena/portal/api/search?result=sequence&query=tax_tree(7215) AND description="alcohol dehydrogenase"&fields=scientific_name,first_public,base_count&limit=0'), destfile = './results/24-02-2026/drosophila.txt')
