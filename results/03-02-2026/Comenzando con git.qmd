...
2. Ignora el contenido de la carpeta local `data` excepto en las subcarpetas que contengan el archivo .gitkeep.
3. Ignora todos los archivos que terminen en `.bam`, `.fa`, `.afa` y `.fasta`, ya que pueden llegar a ser bastante grandes y no nos interesa que se suban a git. Observa el uso del asterisco, "*", como comodín: representa cualquier cadena de caracteres.
